...
public class ItemSpawn_Egg_CorrugatedZombie extends ItemMonsterPlacer
{
	public static Class[] spawnableEntities = {EntityCorrugatedZombie.class,};
	
	public ItemSpawn_Egg_CorrugatedZombie()
	{
