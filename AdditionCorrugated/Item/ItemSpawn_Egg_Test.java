...
import AdditionCorrugated.Entity.EntityCorrugated;
...
public class ItemSpawn_Egg_Test extends ItemMonsterPlacer
{
	public final int primaryColer;
	
	public final int secondaryColer;
	
	public static Class[] spawnableEntities = {EntityCorrugated.class,};
	
	public ItemSpawn_Egg_Test(int par1, int par2)
	{
		this.setHasSubtypes(true);
		this.primaryColer = par1;
		this.secondaryColer = par2;
	}
	
	@SideOnly(Side.CLIENT)
	public int getColerFromItemStack(ItemStack par1ItemStack, int par2)
	{
		return par2 == 0 ? primaryColer : secondaryColer;
	}
//	
	@Override
