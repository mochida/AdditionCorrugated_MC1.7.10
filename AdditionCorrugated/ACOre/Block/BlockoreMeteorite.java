...
public class BlockoreMeteorite extends Block implements IWorldGenerator
{
	...
	{
		super(Material.iron);
		setBlockName("OreMeteorite");
		setBlockTextureName("additioncorrugated:block_oremeteorite");
		setHardness(2.0F);
		setResistance(1.0F);
	...
	private void generateOre(World world, Random random, int x, int z)
	{
		for (int i = 0; i < 10; ++i)
		{
			...
			(new WorldGenMinable(AdditionCorrugated.ACOre.Block.Blocks.oreMeteorite, 5)).generate(world, random, genX, genY, genZ);
		}
	}
}